...
//        throw std::runtime_error("not implemented yet");
        ...
        const int n_trials = 100000; // TODO: numbers

        const double threshold_px = 3;

        const int n_samples = 6; // TODO: numbers
        uint64_t seed = 1;
        ...
        for (int i_trial = 0; i_trial < n_trials; ++i_trial) {
            ...
            for (int i = 0; i < n_points; ++i) {
                ...
                p /= p[2];
                cv::Vec2d px = cv::Vec2d(p[0], p[1]);//спроецировать 3Д точку в пиксель с использованием P и calib;
